...
다른 목록은 “있다”를 말한다. 이 목록은 **지금 되냐**를 잰다. 2026-09-07 기준 주소를 확인한 79건 중 **61건이 살아있음 확인**, 15건은 **확인 못 함**, 3건만 **죽음 확인**이다. 확인 못 함은 사망이 아니다 — 우리가 못 본 것과 그쪽이 없는 것은 다르다.
...
|---|---|---|---|---|---|---|
| [hike-lab/public-data-lens](https://github.com/hike-lab/public-data-lens)<br><sub>카탈로그형 — 값이 아니라 데이터셋 위치를 준다</sub><br><sub>지난 회차 표기 `haklaekim/public-data-lens` → `hike-lab/public-data-lens` — 같은 서버로 이었고, 등수는 옛 이름으로 받은 것이다</sub> | 9 | 25 | 31 | 100% | 100% | 1 |
...
| 서버 | 도구 | 웜ms | 콜드ms | 설명 | 주석 | 사실오류 |
|---|---|---|---|---|---|---|
| [kr.co.reevl/reevl-mcp](https://reevl.co.kr/mcp)<br><sub>지난 회차 표기 `exclusiveyon-a11y/reevl-plugins` → `kr.co.reevl/reevl-mcp` — 같은 서버로 이었다</sub> | 7 | 31 | 46 | 100% | 100% | — |
